from agant.default_values import default_values
from agant.validate import validate_check
from agant.make_directory import make_directory
from agant.cuda_check import cuda_check
from agant.make_models import make_models
from agant.reading_data import reading_data
from agant.train_GAN import train_GAN
from agant.save_models import save_models
from agant.evaluate import evaluate
from agant.argument_parser import argument_parser
from time import time

def driver_gan_generation(config_file_path):
	"""Driver function."""
	start = time()
	conf_data = argument_parser(config_file_path)
